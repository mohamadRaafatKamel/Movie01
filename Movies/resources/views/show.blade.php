		...
		<div class="row ipad-width2">
			<div class="col-md-4 col-sm-12 col-xs-12">
				<div class="movie-img sticky-sb">
					<img src="{{ 'https://image.tmdb.org/t/p/w500/'.$MoviesInfo['poster_path'] }}" alt="">
					<div class="movie-btn">
			...
			<div class="col-md-8 col-sm-12 col-xs-12">
				<div class="movie-single-ct main-content">
					<h1 class="bd-hd">{{ $MoviesInfo['original_title']}}<span></span></h1>
					...
					<div class="movie-rate">
						<div class="rate">
							...
							<p><span>{{ $MoviesInfo['vote_average'] }}</span> /10<br>
								<span class="rv">{{ $MoviesInfo['vote_count'] }} Reviews</span>
							</p>
						</div>
						<div class="rate-star">
